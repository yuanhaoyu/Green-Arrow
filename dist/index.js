...
class Arrow {
  ...
  _init() {
    ...
    this.base.ua = _tool2.default.getUA();
  }
  _sendMsg(msg = {}) {
    if (this.type === 'GET') {
      let img = new Image();
...
},{"../common/tool":3,"intersection-observer":5}],1:[function(require,module,exports) {
"use strict";
...
},{"./arrow":4,"./common/tool":3}],0:[function(require,module,exports) {
...
if (!module.bundle.parent) {
  var ws = new WebSocket('ws://localhost:57307/');
